...
The high-level vision, conceptual architecture, and product goals for an AI-powered adaptive educational platform were directly inspired by the initial work of the **Athenos** project.

* **Original Project Name:** Athenos
* **Original Repository:** Original - https://github.com/epiGnosko/Athenos
                           The appropriated - https://github.com/DevFestHackathon2025/Athenos-Next

* **Original License:** MIT License

We acknowledge and respect the foundation laid by the original creator(s) in publishing this work, which served as a valuable inspiration for our own project's direction.
...
* **Copyright Separation:** The copyright in the code of this repository belongs entirely to The Promethean Society.
