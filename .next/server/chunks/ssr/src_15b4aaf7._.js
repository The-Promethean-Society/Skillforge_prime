...
function CompetencyEvents() {
    ...
    const handleGenerateEvents = ()=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$094968__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateCompetencyBuildingEvents"])({
                userSkills: [
                    'Python',
                    'Data Analysis'
                ],
...
//# sourceMappingURL=src_15b4aaf7._.js.map